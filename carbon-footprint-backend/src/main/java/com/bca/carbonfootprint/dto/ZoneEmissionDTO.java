...
public class ZoneEmissionDTO {

    private Long zoneId;
    private String zoneName;
    private Double totalEmission;
    private Double averageEmission;
    private Long totalUsers;   // ADD THIS

    public ZoneEmissionDTO() {}

    public ZoneEmissionDTO(Long zoneId, String zoneName,
                           Double totalEmission, Double averageEmission) {
        this.zoneId = zoneId;
